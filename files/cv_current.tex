...
\item Wan, Allison, and \textbf{Jon Green}. "Political Pundits and the Maintenance of Ideological Coalitions." Accepted, \textit{Political Behavior}.
\begin{itemize}
\item Working paper: \url{https://osf.io/8c3fr/files/cngma}
\end{itemize}
...
\item "Niche Ideologies in the Mass Public: The Case of Christian Nationalism," with Nick Davis.
...
\item A Framework for Analyzing Podcasts and Their Audiences at Scale. Center for Social Media and Politics (CSMAP) Lab, New York University, May 2026 (scheduled).

\item A Framework for Analyzing Podcasts and Their Audiences at Scale. Media Effects Empirical Workshop, Columbia University, May 2026 (scheduled).
