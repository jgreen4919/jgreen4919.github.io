...
\item Benegal, Salil, and \textbf{Jon Green}. "Cost Sensitivity, Partisan Cues, and Support for the Green New Deal." In press, \textit{Journal of Environmental Studies and Sciences}.

\item \textbf{Green, Jon}, Kelsey Shoub, Rachel Blum, and Lindsey Cormack. "Cross-Platform Partisan Positioning in Congressional Speech." In press, \textit{Political Research Quarterly}.
\begin{itemize}
\item Working paper: \url{https://osf.io/85atn}
\end{itemize}

\item Lunz Trujillo, Kristin, \textbf{Jon Green}, Alauna Safarpour, David Lazer, Jennifer Lin, and Matthew Motta. "Covid-19 Spillover Effects onto General Vaccine Attitudes." \textit{Public Opinion Quarterly}, nfad059.\\
